...
2. **Username Convention:** If creating a new account for work, we recommend a clean format such as `FirstnameLastname-Org` (e.g., `SamuelChiu-NOAA`) or your standard agency format.
